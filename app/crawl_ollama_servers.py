...
# def check_address():
#     iteams = getAllUrl()['data']

#     def check_single_iteam(iteam):
#         url = iteam['url']
#         soup = 获取网址代码(f'http://{url}')
#         if soup is not None:
#             data = {
#                 'id': iteam['id'],
#                 'status': 'ENABLE'
...
#     # 创建线程池，最大并发数建议根据实际情况调整（例如5）
#     with ThreadPoolExecutor(max_workers=11) as executor:
#         futures = [executor.submit(check_single_iteam, iteam) for iteam in iteams]
